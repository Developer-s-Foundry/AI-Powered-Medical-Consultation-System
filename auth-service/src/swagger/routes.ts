...
const models: TsoaRoute.Models = {
    "User": {
        ...
        "properties": {
            ...
            "resetPasswordTokens": {"dataType":"array","array":{"dataType":"refObject","ref":"ResetPasswordToken"},"required":true},
            "refreshTokens": {"dataType":"array","array":{"dataType":"refObject","ref":"RefreshToken"},"required":true},
            "emailVerificationTokens": {"dataType":"array","array":{"dataType":"refObject","ref":"EmailVerificationToken"},"required":true},
        },
...
export function RegisterRoutes(app: Router) {
    ...
    // ###########################################################################################################
        ...
        const argsUserController_verifyEmail: Record<string, TsoaRoute.ParameterSchema> = {
                requestBody: {"in":"body","name":"requestBody","required":true,"dataType":"nestedObjectLiteral","nestedProperties":{"token":{"dataType":"string","required":true},"email":{"dataType":"string","required":true}}},
        };
        ...
        const argsUserController_resetPassword: Record<string, TsoaRoute.ParameterSchema> = {
                requestBody: {"in":"body","name":"requestBody","required":true,"dataType":"nestedObjectLiteral","nestedProperties":{"token":{"dataType":"string","required":true},"newPassword":{"dataType":"string","required":true},"email":{"dataType":"string","required":true}}},
        };
        ...
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        const argsUserController_initiateEmailVerification: Record<string, TsoaRoute.ParameterSchema> = {
                requestBody: {"in":"body","name":"requestBody","required":true,"dataType":"nestedObjectLiteral","nestedProperties":{"email":{"dataType":"string","required":true}}},
        };
        app.post('/users/initiate-email-verification',
            ...(fetchMiddlewares<RequestHandler>(UserController)),
            ...(fetchMiddlewares<RequestHandler>(UserController.prototype.initiateEmailVerification)),

            async function UserController_initiateEmailVerification(request: ExRequest, response: ExResponse, next: any) {

            // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa

            let validatedArgs: any[] = [];
            try {
                validatedArgs = templateService.getValidatedArgs({ args: argsUserController_initiateEmailVerification, request, response });

                const controller = new UserController();

              await templateService.apiHandler({
                methodName: 'initiateEmailVerification',
                controller,
                response,
                next,
                validatedArgs,
