...
async function startServer() {
  try {
    ...
    const server = app.listen(config.app.port, () => {
      ...
      logger.info(`  - POST /api/pharm/prescription/create (Doctor)`);
      logger.info(`  - GET  /api/prescription/view (Patient/Doctor)`);
      logger.info(`  - POST /api/drugs/create (Pharmacy)`);
      logger.info(`  - GET  /api/drugs/search (Public)`);
      logger.info("=================================================");
      logger.info("");
    });
